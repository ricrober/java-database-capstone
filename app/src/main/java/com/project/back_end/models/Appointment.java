...
public class Appointment {
    ...
    public Appointment(Long id, @NotNull(message = "Doctor must be assigned to the appointment") Doctor doctor,
            @NotNull(message = "Patient must be assigned to the appointment") Patient patient,
